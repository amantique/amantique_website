            ...
            <div className="text-center text-white">
              ...
              <div className="sm:text-base flex flex-col items-center justify-center text-justify font-robotomono max-w-7xl">
                <div className="w-full p-4">
                  ...
                  <p className="font-medium leading-relaxed mb-4">
                    Été <span className="font-bold">2024</span>, le groupe a enregistré son premier <span className="font-bold">EP &quot;Laurent&qot;</span> au Studio Arpège à Nantes, le tout mixé par le superbe anglais <span className="font-bold">Alistair Groves</span> au <span className="font-bold">Motor Museum Studio</span> à Liverpool (Oasis, Arctic Monkeys, Bring Me The Horizon...) et masterisé par l&apos;aussi superbe et anglais <span className="font-bold">Grant Berry</span> à Manchester (While She Sleeps, Busted...).
                  </p>
                  <p className="font-medium leading-relaxed mb-4">
                    Après une <span className="font-bold">trentaine de concerts</span> à Paris et en région parisienne, incluant des salles emblématiques tels que le <span className="font-bold">Pop Up, le Supersonic</span> ou encore <span className="font-bold">l&apos;International</span>, Amantique a sorti son <span className="font-bold">premier single &qot;Eau Salée&qot;</span> le <span className="font-bold">11 octobre</span>, suivi d’un second, <span className="font-bold">&qot;Anges & Mouches&qot;</span> le <span className="font-bold">3 décembre</span>, le tout en <span className="font-bold">2024</span>.
                  </p>
                  <p className="font-medium leading-relaxed mb-4">
                    Leur premier EP <span className="font-bold">&qot;Laurent&qot;</span> est sorti le <span className="font-bold">17 février 2025</span>. Un gros caillou brut. Mais aussi un léger bourdonnement, celui d&apos;un insecte qui, après avoir pondu de beaux œufs, s&apos;en va marcher un coup.
                  </p>
                </div>
              </div>
            </div>
